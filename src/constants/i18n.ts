...
export const i18nText = {
  zh: {
    ...
    scriptTip: '<b>elem</b> 为当前组件的 DOM 元素。<br/><b>props</b> 为当前组件的配置数据。',
    customStyle: '样式',
    stylePlaceholder: 'transform: rotate(45deg)\ntransform-origin: center',
    styleTip: '请使用 CSS 样式语法，每行一个样式。',
    code: '代码',
    ...
    domainVerifyEmptyMsg: '子域名不能为空或者为www',
    ...
    link: '链接',
    function: '脚本方法',
    functionTip: '<b>event</b><em>[Obj]</em>: 本次事件<br/><b>data</b><em>[Obj]</em>: 组件数据<br/><b>name</b><em>[Func]</em>: 通过名字获取对应元素<br/><b>tag</b><em>[Func]</em>: 通过 Tag 获取对应元素<br/><b>getDataByName</b><em>[Func]</em>: 通过名字获取组件数据<br/><b>getDataByTag</b><em>[Func]</em>: 通过 Tag 获取组件数据列表',
    scrollTo: '滚动至',
    ...
    saveTemplateTip: '暂无模板，你需要先创建一个项目，并保存为模板。',
    saveMaterialTip: '暂无物料，你需要在编辑页面中选中一个组件并保存。',
    setting: '设置',
    switchToZH: '切换至中文',
...
`,
  ...
  en: {
    ...
    script: 'Scripts',
    scriptPlaceholder: 'elem.ondblclick = () => alert("Hello")',
    scriptTip: '<b>elem</b>: The DOM element<br/><b>props</b>: Configuration data',
    customStyle: 'Styles',
    stylePlaceholder: 'transform: rotate(45deg)\ntransform-origin: center',
    ...
    domainVerifyEmptyMsg: 'The subdomain cannot be empty or www',
    ...
    link: 'Link',
    function: 'Function',
    functionTip: '<b>event</b><em>[Obj]</em>: current event<br/><b>data</b><em>[Obj]</em>: node data<br/><b>name</b><em>[Func]</em>: get element by name<br/><b>tag</b><em>[Func]</em>: get element list by tag name<br/><b>getDataByName</b><em>[Func]</em>: get node data by name<br/><b>getDataByTag</b><em>[Func]</em>: get node data list by tag',
    scrollTo: 'Scroll To',
    componentName: 'Component Name',
    scrollToPlaceholder: 'Component Name or Distance to Top',
    linkPlaceholder: 'Enter a link here',
    functionPlaceholder: 'The node data modified will take effect immediately. If you want to trigger an event, need to click the unlock button.',
    ...
    saveTemplateTip: 'No template is available, you need to create a project first and save it as a template.',
    saveMaterialTip: 'No material is available, you need to select a component in the edit page and save it.',
    setting: 'Setting',
