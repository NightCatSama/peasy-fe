...
export const i18nText = {
  zh: {
    ...
    backgroundClipTextTip: '需要先将字体颜色设置透明度，否则无法生效',
    backgroundColor: '背景色',
    backgroundLink: '图片地址',
    backgroundSize: '图片大小',
...
`,
  ...
  en: {
    ...
    backgroundClipTextTip: 'Need to set the transparency of the font color first, otherwise it will not take effect',
