  ...
  return {
    ...
    transformIndexHtml: (file) => {
      if (process.env.NODE_ENV === 'development') {
        file = parsePageData(testData, file)
      }
      return file
    },
